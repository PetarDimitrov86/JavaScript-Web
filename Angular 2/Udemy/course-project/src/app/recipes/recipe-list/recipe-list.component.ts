...
export class RecipeListComponent implements OnInit {
  recipes: Recipe[] = [
    ...
    new Recipe('Second Recipe', 'This is another recipe', 'https://www.bbcgoodfood.com/sites/default/files/recipe-collections/collection-image/2013/05/frying-pan-pizza-easy-recipe-collection.jpg')
  ];
